<script lang="ts">
    ...
    import { setHomePage } from "./router";
    import { loadWindow, quitApp, setWindowMinimise, alwaysOnTopStore, toggleWindowAlwaysOnTop } from "./window"
...
<header class="flex center-y">
    ...
    {#if $alwaysOnTopStore}
        <button class="ip-icon-button" on:click={toggleWindowAlwaysOnTop} title="Disable Always on Top">
            <svg style="height: 0.875rem;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M12 17v5"/>
    ...
    <button class="ip-icon-button" on:click={quitApp} title="Quit App">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M18 6 6 18"/>
            <path d="m6 6 12 12"/>
        </svg>
